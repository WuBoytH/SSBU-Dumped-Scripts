...
game_Born = function ()
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP(0, 0, 0x031ED91FCA, 25, 361, 30, 0, 80, 12, 0, 0, 0, 0x13BEB18342, 0, 0.800000011920929, 1, false, false, 40, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_FIRE, COLLISION_SITUATION_MASK_GA, false, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIEB, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_SPEED, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE)
