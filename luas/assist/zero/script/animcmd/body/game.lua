...
game_AttackRyuuenjin = function ()
    ...
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
        sv_animcmd.ATTACK_FP(0, 0, 0x051129036E, 1.2000000476837158, 367, 100, 120, 0, 8, 0xFFFFFFFFFFFFFFFB, 0, 0, 0x13BEB18342, 0, 0.8999999761581421, 1, false, false, 0, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_FIRE, COLLISION_SITUATION_MASK_GA, false, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_ALL, false, COLLISION_PART_MASK_ALL, false, true, false, false, 2, false, false, ATTACK_LR_CHECK_REVERSE, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE)
        sv_animcmd.ATTACK_FP(1, 0, 0x051129036E, 1.2000000476837158, 367, 100, 120, 0, 7, 0xFFFFFFFFFFFFFFFB, 0, 6, 0x13BEB18342, 0, 0.8999999761581421, 1, false, false, 0, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_FIRE, COLLISION_SITUATION_MASK_GA, false, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_ALL, false, COLLISION_PART_MASK_ALL, false, true, false, false, 2, false, false, ATTACK_LR_CHECK_REVERSE, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE)
        sv_animcmd.ATTACK_FP(2, 0, 0x051129036E, 1.2000000476837158, 367, 100, 120, 0, 6, 0xFFFFFFFFFFFFFFFB, 0, 11, 0x13BEB18342, 0, 0.8999999761581421, 1, false, false, 0, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_FIRE, COLLISION_SITUATION_MASK_GA, false, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_ALL, false, COLLISION_PART_MASK_ALL, false, true, false, false, 2, false, false, ATTACK_LR_CHECK_REVERSE, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE)
    end
    sv_animcmd.frame(12)
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
