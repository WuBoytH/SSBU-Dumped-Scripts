...
effect_Attack = function ()
    if sv_animcmd.is_excute() then
        sv_animcmd.EFFECT_FOLLOW(0x12A4900908, 0x031ED91FCA, 0, 0, -7, 90, 0, 0, 1.5, false)
    end
    sv_animcmd.frame(14)
    if sv_animcmd.is_excute() then
        sv_animcmd.EFFECT_FOLLOW_NO_STOP(0x10FB8BE996, 0x031ED91FCA, 0, 0, -7, 90, 0, 0, 1.5, false)
    end
    return 
end
...
effect_AttackFlatStageLeft = function ()
    if sv_animcmd.is_excute() then
        sv_animcmd.EFFECT_FOLLOW(0x12A4900908, 0x031ED91FCA, 2, 0, -17, 90, 0, 0, 1.5, false)
    end
    sv_animcmd.frame(14)
    if sv_animcmd.is_excute() then
        sv_animcmd.EFFECT_FOLLOW_NO_STOP(0x10FB8BE996, 0x031ED91FCA, 2, 0, -17, 90, 0, 0, 1.5, false)
    end
    return 
end
