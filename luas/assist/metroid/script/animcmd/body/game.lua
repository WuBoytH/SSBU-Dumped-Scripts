...
game_Move = function ()
    if sv_animcmd.is_excute() then
        sv_animcmd.SEARCH_LEGACY(0, 0, 0x035DBFE258, 7, 0, -3, 0, COLLISION_KIND_MASK_HIT, COLLISION_CATEGORY_MASK_FIGHTER, COLLISION_SITUATION_MASK_GA, false, COLLISION_PART_MASK_BODY_HEAD, HIT_STATUS_MASK_NORMAL, false, 1, false, COLLISION_SHAPE_TYPE_SPHERE)
    end
    return
end
