...
game_Jump = function ()
    ...
    sv_animcmd.frame(19)
    if sv_animcmd.is_excute() then
        sv_animcmd.CATCH_FIGHTER(0, 0x04A7F3F69C, 3, 7, 0xFFFFFFFFFFFFFFFF, 0, 7, 0xFFFFFFFFFFFFFFFF, 0, FIGHTER_STATUS_KIND_CAPTURE_CLAPTRAP, COLLISION_SITUATION_MASK_GA)
    ...
    sv_animcmd.frame(23)
    if sv_animcmd.is_excute() then
        sv_animcmd.CATCH_FIGHTER(0, 0x04A7F3F69C, 4, 4, 0xFFFFFFFFFFFFFFFD, 0, 4, 0xFFFFFFFFFFFFFFFD, 0, FIGHTER_STATUS_KIND_CAPTURE_CLAPTRAP, COLLISION_SITUATION_MASK_GA)
