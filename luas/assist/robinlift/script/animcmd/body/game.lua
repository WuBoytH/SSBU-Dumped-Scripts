...
game_Appear = function ()
    ...
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK(3, 0, 0x09B3932715, 0, 0xFFFFFFFFFFFFFF65, 100, 125, 0, 9, 0, 5, 7, 0, 5, 7, 1, 1, ATTACK_SETOFF_KIND_OFF, ATTACK_LR_CHECK_POS, true, 1, 0, 0, false, false, false, false, false, COLLISION_SITUATION_MASK_GA, COLLISION_CATEGORY_MASK_NO_STAGE_GIMMICK, COLLISION_PART_MASK_ALL, false, 0x15A2C502B3, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_NONE, ATTACK_REGION_NONE)
        sv_animcmd.ATTACK(4, 0, 0x09AA881654, 0, 0xFFFFFFFFFFFFFF65, 100, 125, 0, 9, 0, 6, -1, 0, 6, -1, 1, 1, ATTACK_SETOFF_KIND_OFF, ATTACK_LR_CHECK_POS, true, 1, 0, 0, false, false, false, false, false, COLLISION_SITUATION_MASK_GA, COLLISION_CATEGORY_MASK_NO_STAGE_GIMMICK, COLLISION_PART_MASK_ALL, false, 0x15A2C502B3, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_NONE, ATTACK_REGION_NONE)
    end
    sv_animcmd.frame(31)
    if sv_animcmd.is_excute() then
    ...
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
        sv_animcmd.CATCH_FIGHTER(0, 0x031ED91FCA, 17, 0, 15, 8, 0, 15, 0xFFFFFFFFFFFFFFF8, FIGHTER_STATUS_KIND_CAPTURE_NABBIT, COLLISION_SITUATION_MASK_GA)
