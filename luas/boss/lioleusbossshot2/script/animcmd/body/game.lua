...
game_Born = function ()
    ...
    if sv_animcmd.is_excute() then
        ...
        AttackModule.set_offset(1, 0, 0, 0xFFFFFFFFFFFFFFEE)
    ...
    if sv_animcmd.is_excute() then
        ...
        AttackModule.set_offset(1, 0, 0, 0xFFFFFFFFFFFFFFE6)
    ...
    if sv_animcmd.is_excute() then
        ...
        AttackModule.set_offset(1, 0, 0, 0xFFFFFFFFFFFFFFDE)
    ...
    if sv_animcmd.is_excute() then
        ...
        AttackModule.set_offset(1, 0, 0, 0xFFFFFFFFFFFFFFD6)
