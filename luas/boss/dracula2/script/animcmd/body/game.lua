...
game_FrontJump = function ()
    ...
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(5, 0, 0x035DBFE258, 3, 8, 270, 60, 40, 0, 0, 55, 54, 9, 9, 0xFFFFFFFFFFFFFFF6, 0, 0, 0x15A2C502B3, 0, 0.20000000298023224, 1, false, true, 1, ATTACK_SOUND_LEVEL_M, COLLISION_SOUND_ATTR_KICK, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 120, false, false, ATTACK_LR_CHECK_SPEED, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    ...
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(1, 0, 0x0570211EBD, 2, 5, 60, 82, 65, 0, 0, 100, 100, 12, 12, 0, 5, 0xFFFFFFFFFFFFFFF1, 0x15A2C502B3, 0, 0.5, 1, false, true, 1, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_KICK, COLLISION_SITUATION_MASK_G, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 120, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(67)
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
...
game_Slash = function ()
    ...
    sv_animcmd.frame(24)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(3, 0, 0x051A07C0E7, 8, 16, 30, 50, 30, 0, 0, 55, 54, 9, 9, 8, 5, 0xFFFFFFFFFFFFFFF6, 0x14860B063A, 0, 1.2000000476837158, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(25)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(3, 0, 0x051A07C0E7, 8, 16, 30, 50, 30, 0, 0, 55, 54, 9, 9, 0xFFFFFFFFFFFFFFF8, 0xFFFFFFFFFFFFFFFB, 1, 0x14860B063A, 0, 1.2000000476837158, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(26)
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x031D39A761, 8, 16, 25, 50, 30, 0, 0, 55, 54, 12, 12, 0, 0xFFFFFFFFFFFFFFF8, 8, 0x14860B063A, 0.25, 1, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(27)
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
...
game_SlashThree = function ()
    ...
    sv_animcmd.frame(28)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x031D39A761, 3, 6, 30, 100, 100, 80, 100, 0, 0, 13, 13, 0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFF7, 10, 0x14860B063A, 0, 0.800000011920929, 1, false, true, 0.5, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 6, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    ...
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(3, 0, 0x05E008FD84, 3, 6, 40, 100, 100, 85, 85, 0, 0, 8, 8, 0, 0, 1, 0x14860B063A, 0, 0.800000011920929, 1, false, true, 1, ATTACK_SOUND_LEVEL_M, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 6, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x031D39A761, 3, 6, 30, 100, 100, 90, 90, 0, 0, 12, 12, 15, 0xFFFFFFFFFFFFFFF7, 12, 0x14860B063A, 0, 0.800000011920929, 1, false, true, 1, ATTACK_SOUND_LEVEL_M, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 6, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    ...
    sv_animcmd.frame(78)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x031D39A761, 6, 12, 30, 50, 30, 0, 0, 55, 55, 12, 12, 0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFF7, 15, 0x1569C518B1, 0, 1, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
...
game_StepSlash = function ()
    ...
    sv_animcmd.frame(30)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(1, 0, 0x051A07C0E7, 8, 16, 30, 50, 30, 0, 0, 55, 54, 8, 8, 0xFFFFFFFFFFFFFFF8, 0xFFFFFFFFFFFFFFFB, 1, 0x14860B063A, 0, 1.2000000476837158, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(31)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(1, 0, 0x051A07C0E7, 8, 16, 30, 50, 30, 0, 0, 55, 54, 8, 8, 10, 0xFFFFFFFFFFFFFFFB, 0, 0x14860B063A, 0, 1.2000000476837158, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    ...
    sv_animcmd.frame(32)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(5, 0, 0x031D39A761, 8, 16, 30, 50, 30, 0, 0, 55, 54, 12, 12, 0, 0xFFFFFFFFFFFFFFF8, 6, 0x14860B063A, 0.25, 1, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(34)
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
...
game_TurnSlash = function ()
    ...
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(3, 0, 0x051A07C0E7, 7, 14, 30, 50, 30, 0, 0, 55, 54, 7, 7, 0xFFFFFFFFFFFFFFFB, 0, 1, 0x14860B063A, 0, 1.2000000476837158, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(22)
    if sv_animcmd.is_excute() then
    ...
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x031D39A761, 7, 14, 25, 50, 30, 0, 0, 55, 54, 12, 12, 0, 0xFFFFFFFFFFFFFFF8, 0xFFFFFFFFFFFFFFE7, 0x14860B063A, 0.25, 0.800000011920929, 1, false, true, 1, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(25)
    if sv_animcmd.is_excute() then
        AttackModule.clear_all()
...
game_Strike = function ()
    ...
    sv_animcmd.frame(35)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(3, 0, 0x05E008FD84, 8, 20, 50, 100, 55, 0, 0, 55, 80, 7, 7, 0, 6, 0xFFFFFFFFFFFFFFFD, 0x1569C518B1, 0, 1.2000000476837158, 1, false, true, 2, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(36)
    if sv_animcmd.is_excute() then
...
game_StepStrike = function ()
    ...
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x092332B09B, 8, 16, 60, 55, 40, 0, 0, 55, 54, 8, 8, 0, 0xFFFFFFFFFFFFFFF1, 1, 0x1569C518B1, 0, 0.5, 1, false, true, 1, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(29)
    if sv_animcmd.is_excute() then
        sv_animcmd.ATTACK_FP_STRENGTH(4, 0, 0x092332B09B, 8, 16, 60, 55, 40, 0, 0, 55, 54, 8, 8, 0, 0xFFFFFFFFFFFFFFFC, 1, 0x1569C518B1, 0, 0.5, 1, false, true, 1, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_CUTUP, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 60, false, false, ATTACK_LR_CHECK_POS, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
    end
    sv_animcmd.frame(30)
    if sv_animcmd.is_excute() then
        AttackModule.clear(4)
...
game_SquashStart = function ()
    ...
    if sv_animcmd.is_excute() then
        AttackModule.clear(1)
        AttackModule.clear(6)
        sv_animcmd.ATTACK_FP_STRENGTH(0, 2, 0x051129036E, 5, 14, 65, 100, 50, 0, 0, 45, 75, 10, 10, 0, 0, 0xFFFFFFFFFFFFFFFB, 0x15A2C502B3, 0, 1, 1, false, true, 1, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_PUNCH, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 120, false, false, ATTACK_LR_CHECK_REVERSE, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
        ...
        sv_animcmd.ATTACK_FP_STRENGTH(4, 2, 0x054F934137, 5, 14, 115, 100, 50, 0, 0, 45, 75, 10, 10, 0, 5, 0xFFFFFFFFFFFFFFF1, 0x15A2C502B3, 0, 1, 1, false, true, 1, ATTACK_SOUND_LEVEL_L, COLLISION_SOUND_ATTR_KICK, COLLISION_SITUATION_MASK_GA, true, ATTACK_REGION_NONE, COLLISION_CATEGORY_MASK_FIGHTER, false, COLLISION_PART_MASK_ALL, false, true, false, false, 120, false, false, ATTACK_LR_CHECK_REVERSE, false, false, false, false, false, COLLISION_SHAPE_TYPE_SPHERE, WorkModule:get_float(ITEM_INSTANCE_WORK_FLOAT_STRENGTH))
