...
game_Throw = function ()
    if sv_animcmd.is_excute() then
        ...
        sv_animcmd.ATTACK(0, 0, 0x031ED91FCA, 0.10000000149011612, 45, 100, 30, 0, 1.399999976158142, 0, 0, 0, f1_local0, f1_local1, f1_local2, 0, 1, ATTACK_SETOFF_KIND_OFF, ATTACK_LR_CHECK_SPEED, false, 0, 0, 0, true, false, false, false, false, COLLISION_SITUATION_MASK_GA, COLLISION_CATEGORY_MASK_NO_STAGE, COLLISION_PART_MASK_ALL, false, 0x15A2C502B3, ATTACK_SOUND_LEVEL_S, COLLISION_SOUND_ATTR_NONE, ATTACK_REGION_BOMB)
