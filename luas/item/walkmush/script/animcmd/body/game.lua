...
game_Throw = function ()
    if sv_animcmd.is_excute() then
        ...
        sv_module_access:attack(MA_MSC_CMD_ATTACK_FP_CAPSULE, 1, 0, 0x031ED91FCA, 2, 361, 70, 0, 30, 2, 0, 0, 0, 0x1C655B0AE7, 0, 0.4000000059604645, 1, true, false, 0, ATTACK_SOUND_LEVEL_M, COLLISION_SOUND_ATTR_KICK, COLLISION_SITUATION_MASK_GA, false, ATTACK_REGION_OBJECT, COLLISION_CATEGORY_MASK_NO_STAGE, false, COLLISION_PART_MASK_ALL, false, true, true, false, ITEM_TRWATK_F, false, false, ATTACK_LR_CHECK_SPEED, false, false, false, false, false, 0, 0xFFFFFFFFFFFFFFFC, 0)
