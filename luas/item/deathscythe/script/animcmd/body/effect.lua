...
effect_HaveAttack = function ()
    if sv_animcmd.is_excute() then
        sv_animcmd.AFTER_IMAGE4_ON_arg29(0x1529B22888, 0x155EB5181E, 5, 0x06B66091F2, 0, 0xFFFFFFFFFFFFFFFE, 0, 0x06B66091F2, 0, 2, 0, true, 0x1534F2F9EA, 0x06B66091F2, 0, 0, 0, 0, 0, 0, 1, 0, EFFECT_AXIS_Y, 0, TRAIL_BLEND_ALPHA, 101, TRAIL_CULL_NONE, 1.399999976158142, 0)
...
effect_HaveAttack2 = function ()
    if sv_animcmd.is_excute() then
        sv_animcmd.AFTER_IMAGE4_ON_arg29(0x15C7BC49A4, 0x155EB5181E, 5, 0x06B66091F2, 0, 0xFFFFFFFFFFFFFFFD, 0, 0x06B66091F2, 0, 2, 0, true, 0x0425CBFC4F, 0x06B66091F2, 0, 0, 0, 0, 0, 0, 1, 0, EFFECT_AXIS_Y, 0, TRAIL_BLEND_ALPHA, 101, TRAIL_CULL_NONE, 1.399999976158142, 0)
